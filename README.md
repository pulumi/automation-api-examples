...
[Inline/Local Hybrid Program](python/inline_local_hybrid) | Share one inline Python program between an Automation API driver and a Pulumi CLI project, preserving both debuggable automation and manual CLI workflows.
